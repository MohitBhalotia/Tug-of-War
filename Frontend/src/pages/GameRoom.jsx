              ...
              {isAdmin && !roomInfo.winner && (
                <div className="mt-6 bg-gray-800 bg-opacity-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-gray-700 bg-opacity-50 p-3 rounded-lg">
                      <h4 className="font-semibold mb-2 flex items-center justify-center pt-2 sm:pt-4 md:pt-6">
                      ...
                      <div className="space-y-2 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 pb-4 sm:pb-6">
                        
                        <button
                          onClick={resetGame}
                          className="w-full px-3 py-2 sm:py-3 bg-red-600 hover:bg-red-700 rounded-lg text-sm sm:text-base font-medium"
                        >
                          Reset Game
                        </button>
                      </div>
