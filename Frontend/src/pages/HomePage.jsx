    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b] text-white">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-16">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 pb-6 sm:pb-12">
              Tug of War Quiz
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-4 sm:mb-6 px-2">
              A real-time competitive quiz game where teams battle for knowledge supremacy
            </p>
            
            <motion.div 
              className="w-12 sm:w-16 h-12 sm:h-16 mx-auto mb-6 sm:mb-8 cursor-pointer"
          ...
          >
            <motion.button
              ...
              className="px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg text-base sm:text-lg font-semibold shadow-lg transition-all duration-200 flex items-center justify-center"
            ...
            <motion.button
              ...
              className="px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 rounded-lg text-base sm:text-lg font-semibold shadow-lg transition-all duration-200 flex items-center justify-center"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Features Section */}
      <div className="container mx-auto px-4 py-8 sm:py-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12" id="how-it-works">How It Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gray-800 bg-opacity-50 p-4 sm:p-6 rounded-lg shadow-lg"
          >
            <div className="text-blue-400 text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 flex items-center">
              <span className="mr-4">01</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
            </div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Create a Room</h3>
            ...
            <ul className="text-gray-400 text-xs sm:text-sm space-y-1 sm:space-y-2 list-disc pl-5">
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Teams Join</h3>
            <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Battle of Knowledge</h3>
            <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-16">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-gray-800 bg-opacity-30 p-4 sm:p-8 rounded-2xl shadow-xl"
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-center">Game Instructions</h2>
          
          <div className="flex flex-wrap mb-6 sm:mb-8">
            <div className="w-full md:w-1/2 lg:w-1/3 p-2 sm:p-4">
              <div 
                className="bg-gray-700 bg-opacity-50 p-4 sm:p-6 rounded-xl h-full hover:bg-opacity-70 transition-all cursor-pointer"
                onClick={() => setActiveTab("howToPlay")}
              >
                <div className={`h-2 w-full rounded-full mb-3 sm:mb-4 ${activeTab === "howToPlay" ? "bg-blue-500" : "bg-gray-600"}`}></div>
                ...
                <p className="text-gray-300 text-sm sm:text-base">Learn the basic rules and gameplay mechanics</p>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 p-2 sm:p-4">
              ...
              >
                <div className={`h-2 w-full rounded-full mb-3 sm:mb-4 ${activeTab === "scoring" ? "bg-blue-500" : "bg-gray-600"}`}></div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-gray-300 text-sm sm:text-base">Understand how points and rope movement work</p>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 p-2 sm:p-4">
              ...
              >
                <div className={`h-2 w-full rounded-full mb-3 sm:mb-4 ${activeTab === "tips" ? "bg-blue-500" : "bg-gray-600"}`}></div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-gray-300 text-sm sm:text-base">Strategic advice to help your team win</p>
              </div>
            </div>
          </div>
          
          <div className="bg-gray-900 bg-opacity-50 p-4 sm:p-6 rounded-xl">
            <AnimatePresence mode="wait">
              {activeTab === "howToPlay" && (
                ...
                >
                  <h4 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-blue-300">Basic Rules</h4>
                  <ol className="list-decimal pl-5 space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                  ...
                  <div className="flex items-center justify-center mt-4 sm:mt-6">
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 rounded-lg text-white font-medium flex items-center"
              ...
              {activeTab === "scoring" && (
                <motion.div
                  ...
                  className="text-gray-300"
                >
                  <h4 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-blue-300">Scoring System</h4>
                  <ul className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                    ...
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-red-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-yellow-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {activeTab === "tips" && (
                <motion.div
                  ...
                  className="text-gray-300"
                >
                  <h4 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-blue-300">Pro Tips</h4>
      ...
      <div className="container mx-auto px-4 py-8 sm:py-16">
        ...
        >
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-4 sm:mb-6 md:mb-0 md:pr-4 sm:pr-6">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">Real-time Tug of War</h2>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <div className="bg-blue-900 bg-opacity-50 px-3 sm:px-4 py-2 sm:py-3 rounded-lg">
                  <span className="text-blue-300 font-semibold">Real-time Updates</span>
                </div>
                <div className="bg-purple-900 bg-opacity-50 px-3 sm:px-4 py-2 sm:py-3 rounded-lg">
                  <span className="text-purple-300 font-semibold">Socket.io Powered</span>
                </div>
                <div className="bg-green-900 bg-opacity-50 px-3 sm:px-4 py-2 sm:py-3 rounded-lg">
                  <span className="text-green-300 font-semibold">Interactive UI</span>
                </div>
              </div>
            </div>
            <div className="md:w-1/2 bg-gray-900 bg-opacity-70 rounded-xl p-3 sm:p-4 shadow-inner">
              <div className="w-full h-24 sm:h-32 bg-gray-800 rounded-lg flex items-center justify-center relative overflow-hidden">
                <div className="absolute w-full h-8 bg-green-900 opacity-30"></div>
                <div className="absolute left-0 h-full w-1/2 flex items-center justify-start pl-2 sm:pl-4">
                  <span className="font-bold text-blue-400">Team A</span>
                </div>
                <div className="absolute right-0 h-full w-1/2 flex items-center justify-end pr-2 sm:pr-4">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 py-6 sm:py-8 mt-8 sm:mt-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-2 sm:mb-4 md:mb-0">
              <h3 className="text-lg sm:text-xl font-bold">Tug of War Quiz</h3>
